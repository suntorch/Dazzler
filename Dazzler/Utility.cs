...
namespace Dazzler
{
    public static class Utility
    {
        ...
        static public bool ToBool(object value)
        {
            ...
            else if (IsNumeric(value.GetType())) return (ToInt(value) == 1);
        ...
        static public string FastSerialize(string header, object source)
        {
            if (header == null && source == null) return null;

            StringBuilder sb = new StringBuilder(header, 1024);
            if (source != null)
            {
